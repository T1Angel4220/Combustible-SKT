...
/**
 * DTO REST para respuesta de choferes desde el Gateway
 * 
 * @author Sistema SKT
 * @version 1.0.0
 */
public class DriverRestResponse {
    ...
    // Constructores
    public DriverRestResponse() {}
    
    public DriverRestResponse(String id, String nombre, String apellido, String dni, String licencia) {
        this.id = id;
        this.nombre = nombre;
