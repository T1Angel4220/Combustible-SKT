...
public class GrpcServerConfig {
    ...
    public void logGrpcConfiguration() {
        ...
        logger.info("Forzando el inicio del servidor gRPC en puerto 9091");
    }
    ...
    public GrpcServiceDiscoverer grpcServiceDiscoverer() {
        return new AnnotationGrpcServiceDiscoverer() {
            ...
            public Collection<GrpcServiceDefinition> findGrpcServices() {
                ...
                if (services.isEmpty()) {
                    logger.error("NO SE ENCONTRARON SERVICIOS gRPC - Verificar que DriverGrpcController tenga @GrpcService");
                }
                return services;
            }
        };
