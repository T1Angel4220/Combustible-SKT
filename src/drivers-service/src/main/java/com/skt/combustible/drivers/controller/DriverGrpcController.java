...
public class DriverGrpcController extends DriverServiceGrpc.DriverServiceImplBase {
    ...
    @Override
    public void getDriverById(com.skt.combustible.drivers.grpc.GetDriverByIdRequest request,
            StreamObserver<com.skt.combustible.drivers.grpc.DriverResponse> responseObserver) {
        logger.info("gRPC: Obteniendo chofer por ID: {}", request.getId());

        try {
            com.skt.combustible.drivers.domain.dto.DriverResponse response = driverService
                    .getDriverById(String.valueOf(request.getId()));
            com.skt.combustible.drivers.grpc.DriverResponse grpcResponse = mapToGrpcResponse(response);
    ...
    @Override
    public void getDriverByDni(com.skt.combustible.drivers.grpc.GetDriverByDniRequest request,
            StreamObserver<com.skt.combustible.drivers.grpc.DriverResponse> responseObserver) {
        logger.info("gRPC: Obteniendo chofer por DNI: {}", request.getDni());

        try {
            com.skt.combustible.drivers.domain.dto.DriverResponse response = driverService
                    .getDriverByDni(request.getDni());
            com.skt.combustible.drivers.grpc.DriverResponse grpcResponse = mapToGrpcResponse(response);
    ...
    @Override
    public void getDriverByLicense(com.skt.combustible.drivers.grpc.GetDriverByLicenseRequest request,
            StreamObserver<com.skt.combustible.drivers.grpc.DriverResponse> responseObserver) {
        logger.info("gRPC: Obteniendo chofer por licencia: {}", request.getLicencia());

        try {
            com.skt.combustible.drivers.domain.dto.DriverResponse response = driverService
                    .getDriverByLicencia(request.getLicencia());
            com.skt.combustible.drivers.grpc.DriverResponse grpcResponse = mapToGrpcResponse(response);
    ...
    @Override
    public void getAvailableDrivers(com.skt.combustible.drivers.grpc.GetAvailableDriversRequest request,
            StreamObserver<com.skt.combustible.drivers.grpc.GetAvailableDriversResponse> responseObserver) {
        ...
        try {
            ...
            com.skt.combustible.drivers.grpc.GetAvailableDriversResponse.Builder responseBuilder = com.skt.combustible.drivers.grpc.GetAvailableDriversResponse
                    .newBuilder();
            ...
            com.skt.combustible.drivers.grpc.GetAvailableDriversResponse response = responseBuilder
                    .setCount(drivers.size()).build();
    ...
    @Override
    public void getAvailableDriversByMachineryType(
            com.skt.combustible.drivers.grpc.GetAvailableDriversByMachineryTypeRequest request,
            StreamObserver<com.skt.combustible.drivers.grpc.GetAvailableDriversByMachineryTypeResponse> responseObserver) {
        ...
        try {
            ...
            List<com.skt.combustible.drivers.domain.dto.DriverResponse> drivers = driverService
                    .getAvailableDriversByMachineryType(tipoMaquinaria);

            com.skt.combustible.drivers.grpc.GetAvailableDriversByMachineryTypeResponse.Builder responseBuilder = com.skt.combustible.drivers.grpc.GetAvailableDriversByMachineryTypeResponse
                    .newBuilder();
    ...
    public void updateDriver(com.skt.combustible.drivers.grpc.UpdateDriverRequest request,
        ...
        try {
            ...
            com.skt.combustible.drivers.domain.dto.DriverResponse response = driverService
                    .updateDriver(String.valueOf(request.getId()), updateRequest);
            com.skt.combustible.drivers.grpc.DriverResponse grpcResponse = mapToGrpcResponse(response);
    ...
    @Override
    public void changeDriverStatus(com.skt.combustible.drivers.grpc.ChangeDriverStatusRequest request,
            StreamObserver<com.skt.combustible.drivers.grpc.DriverResponse> responseObserver) {
        ...
        try {
            ...
            com.skt.combustible.drivers.domain.dto.DriverResponse response = driverService
                    .changeDriverStatus(String.valueOf(request.getId()), nuevoEstado);
            com.skt.combustible.drivers.grpc.DriverResponse grpcResponse = mapToGrpcResponse(response);
    ...
    @Override
    public void assignMachineryType(com.skt.combustible.drivers.grpc.AssignMachineryTypeRequest request,
            StreamObserver<com.skt.combustible.drivers.grpc.DriverResponse> responseObserver) {
        logger.info("gRPC: Asignando tipo de maquinaria {} al chofer ID: {}", request.getTipoMaquinaria(),
                request.getId());

        try {
            TipoMaquinaria tipoMaquinaria = mapTipoMaquinaria(request.getTipoMaquinaria());
            com.skt.combustible.drivers.domain.dto.DriverResponse response = driverService
                    .assignMachineryType(String.valueOf(request.getId()), tipoMaquinaria);
            com.skt.combustible.drivers.grpc.DriverResponse grpcResponse = mapToGrpcResponse(response);
    ...
    @Override
    public void deactivateDriver(com.skt.combustible.drivers.grpc.DeactivateDriverRequest request,
    ...
    @Override
    public void countAvailableDrivers(com.skt.combustible.drivers.grpc.CountAvailableDriversRequest request,
            StreamObserver<com.skt.combustible.drivers.grpc.CountAvailableDriversResponse> responseObserver) {
        logger.info("gRPC: Contando choferes disponibles");

        try {
            long count = driverService.countAvailableDrivers();

            com.skt.combustible.drivers.grpc.CountAvailableDriversResponse response = com.skt.combustible.drivers.grpc.CountAvailableDriversResponse
                    .newBuilder()
                    .setCount(count)
                    .build();
    ...
    @Override
    public void isDriverAvailable(com.skt.combustible.drivers.grpc.IsDriverAvailableRequest request,
            StreamObserver<com.skt.combustible.drivers.grpc.IsDriverAvailableResponse> responseObserver) {
        ...
        try {
            ...
            com.skt.combustible.drivers.grpc.IsDriverAvailableResponse response = com.skt.combustible.drivers.grpc.IsDriverAvailableResponse
                    .newBuilder()
    ...
    private com.skt.combustible.drivers.grpc.DriverResponse mapToGrpcResponse(
        ...
        com.skt.combustible.drivers.grpc.DriverResponse.Builder builder = com.skt.combustible.drivers.grpc.DriverResponse
                .newBuilder()
    ...
    private EstadoOperativo mapEstadoOperativo(com.skt.combustible.drivers.grpc.EstadoOperativo estado) {
        return switch (estado) {
            ...
            case UNRECOGNIZED -> EstadoOperativo.DISPONIBLE; // Default fallback
        };
    }
