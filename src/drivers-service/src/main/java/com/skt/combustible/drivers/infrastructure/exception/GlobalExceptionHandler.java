package com.skt.combustible.drivers.infrastructure.exception;
...
/**
 * Manejador global de excepciones para el servicio de choferes
 * 
 * @author Sistema SKT
 * @version 1.0.0
 */
...
public class GlobalExceptionHandler {
    ...
    /**
     * Maneja excepciones de chofer no encontrado
     */
    ...
    public ResponseEntity<ErrorResponse> handleDriverDuplicateException(DriverDuplicateException ex) {
    ...
    private String getCurrentPath() {
        // En un contexto real, esto se obtendría del HttpServletRequest
