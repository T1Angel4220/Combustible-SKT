...
public interface DriverRepository extends MongoRepository<Driver, String> {
    ...
    /**
     * Busca choferes disponibles (activos y con estado ACTIVO)
     * @return Lista de choferes disponibles
     */
    @Query("{ 'activo': true, 'estado': 'ACTIVO' }")
     ...
     */
    @Query("{ 'activo': true, 'estado': 'ACTIVO', '$or': [{'tipo_maquinaria_asignada': ?0}, {'tipo_maquinaria_asignada': null}] }")
     ...
     */
    @Query(value = "{ 'activo': true, 'estado': 'ACTIVO' }", count = true)
     ...
     */
    @Query(value = "{ 'activo': true, 'estado': 'ACTIVO', '$or': [{'tipo_maquinaria_asignada': ?0}, {'tipo_maquinaria_asignada': null}] }", count = true)
    ...
    Page<Driver> findByCriterios(EstadoOperativo estado, TipoMaquinaria tipoMaquinaria, Boolean activo, Pageable pageable);
}
